...
def create_hf_experiment(
    author: str, target_loss: float = 0.1, max_epochs: int = 50000
):
    """
...
def main():
    ...
    parser.add_argument(
        "--author", required=True, choices=AUTHORS, help="Author to train"
    )
    parser.add_argument(
        "--target-loss",
        type=float,
    ...
    exp = create_hf_experiment(
        author=args.author, target_loss=args.target_loss, max_epochs=args.max_epochs
    )
    ...
    print("(May require 5,000-10,000+ epochs)\n")
