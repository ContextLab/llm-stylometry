...
{\small\texttt{\{harrison.f.stropkay.25, jiayi.chen.gr,}\\
\texttt{mohammad.javad.latifi.jebelli, daniel.n.rockmore,}\\
\texttt{jeremy.r.manning\}@dartmouth.edu}}
...
inverse relationship with model size. All three models correctly attributed the
...
Thompson. Per-author accuracy, chunk-level purity distributions, and
cross-author confusion patterns are provided in the Supplementary Materials.
