...
same 84-book corpus, book-level attribution accuracy varied across embedding
models: \texttt{[PLACEHOLDER: per-model accuracy numbers]}
(see Appendix for detailed results including chunk-level purity and
cross-author confusion patterns). \texttt{[PLACEHOLDER: interpretation of
results and comparison with our 100\% baseline accuracy]}
...
% TODO: Update after embedding results
Our comparison with pre-trained text embedding models
(\texttt{[PLACEHOLDER: brief summary of embedding results]}) further
highlights the value of author-specific training. \texttt{[PLACEHOLDER:
interpretation depending on whether embeddings match or fall short of our
approach]}
